...
public class ActivityEditPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        code = (EditText) findViewById(R.id.edit_phone_code);
        btnHelp = (ImageButton) findViewById(R.id.edit_phone_btnHelp);
        btn = (Button) findViewById(R.id.edit_phone_btnSMS);
        logo = (ImageButton) findViewById(R.id.edit_phone_logo);
    ...
    private void codeRequest(final String url) {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                ActivityEditPhone.this.runOnUiThread(new Runnable() {
                    public void run() {
